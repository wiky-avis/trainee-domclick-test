    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('repair', 'Специалист по ремонту'), ('service', 'Специалист по обслуживанию'), ('consultant', 'Консультант')], default='user', max_length=20, verbose_name='Права')),
